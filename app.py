...
lineaccesstoken = 'aBBFF8WplUwmF+dTojTDO9u+JvbQsVEeR8QFx3HdyNIfafEGjNwxmTSJEtlBCipvr+ee6rfX7F+KHZJoT4dbLE0yS8KLZbQGuzxFnEMck6EsIuyOpJX5oF5Qjmmny/54mbDwooy9kvTWrbhD90JD8AdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
         ...
         if msg == "สวัสดี" :
             ...
             replyObj = TextSendMessage(text="ไปกันเลยค่ะ")
             line_bot_api.reply_message(rtoken, replyObj)
         elif msg == "ดื่มน้ำมั้ย" :
             replyObj = TextSendMessage(text="ได้ค่ะ")
             line_bot_api.reply_message(rtoken, replyObj)
         else :
             ...
             url = ""
             requests.poshttps://dialogflow.cloud.google.com/v1/integrations/line/webhook/41a5ab4a-8822-4726-9549-ed1e6067d311t(url,data=json_line, headers=json_headers)
     elif msgType == "image":
         try:
